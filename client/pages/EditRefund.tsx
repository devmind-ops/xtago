...
function FormField({ label, value, onChange, placeholder, icon, isDropdown, options }: FormFieldProps) {
  ...
  if (isDropdown && options) {
    return (
      <div className="flex flex-col gap-1.5 sm:gap-2">
        <label className="text-[#F6F6F6] text-sm sm:text-base font-normal font-['Space Grotesk']">{label}</label>
        <div className="relative">
          <button
            onClick={() => setIsOpen(!isOpen)}
            className="w-full flex items-center justify-between px-3 sm:px-4 py-3 sm:py-[18px] rounded-xl sm:rounded-[20px] border border-[#22353E] bg-transparent text-left"
          >
            <span className="text-[#697B7B] text-xs sm:text-sm md:text-base font-normal font-['Space Grotesk'] truncate">
              {value || placeholder}
            </span>
            <ChevronDownIcon />
          </button>
              ...
              <div className="absolute top-full left-0 right-0 z-20 mt-1 bg-[#1C242E] border border-[#22353E] rounded-2xl overflow-hidden shadow-lg">
                {options.map((option) => (
                  <button
                    ...
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm md:text-base text-[#F6F6F6] hover:bg-[#22353E] transition-colors"
                  >
                    {option}
                  </button>
                ))}
  ...
  return (
    <div className="flex flex-col gap-1.5 sm:gap-2">
      <label className="text-[#F6F6F6] text-sm sm:text-base font-normal font-['Space Grotesk']">{label}</label>
      <div className="flex items-center px-3 sm:px-4 py-3 sm:py-[18px] rounded-xl sm:rounded-[20px] border border-[#22353E] bg-transparent">
        <input
          type="text"
          value={value}
          onChange={(e) => onChange(e.target.value)}
          placeholder={placeholder}
          className="flex-1 min-w-0 bg-transparent text-[#F6F6F6] text-xs sm:text-sm md:text-base font-normal font-['Space Grotesk'] outline-none placeholder:text-[#697B7B]"
        />
        {icon && <div className="ml-1.5 sm:ml-2 flex-shrink-0">{icon}</div>}
      </div>
    </div>
  );
}
  ...
  return (
    <div className="min-h-screen bg-[#151D26] relative">
      <div className="max-w-[428px] mx-auto bg-[#151D26] relative overflow-visible pb-[120px]">
        ...
        {/* Content */}
        <div className="flex flex-col items-start gap-4 sm:gap-6 px-3 sm:px-4 mt-6">
          {/* Title and Controls */}
          <div className="flex w-full justify-between items-center gap-2">
            <h1 className="text-[#F6F6F6] text-base sm:text-lg md:text-xl font-bold font-['Space Grotesk'] flex-shrink-0">Edit Refund</h1>
            <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
              {/* Search Button */}
              <button className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-[#1C242E] rounded-2xl">
                <SearchIcon />
              </button>
              {/* QR Scan Button */}
              <button
                onClick={() => setShowQRCode(!showQRCode)}
                className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-[#1C242E] rounded-2xl hover:bg-[#22353E] transition-colors"
              >
                <QrScanIcon />
              </button>
              {/* Filter Button */}
          ...
          <div className="flex justify-center w-full">
            {showQRCode ? (
              <svg
                ...
                height="180"
                viewBox="0 0 208 208"
                className="w-[180px] h-[180px] sm:w-[200px] sm:h-[200px] md:w-[208px] md:h-[208px] flex-shrink-0"
                fill="none"
              ...
              <img
                ...
                alt="Product Image"
                className="w-[180px] h-[220px] sm:w-[200px] sm:h-[240px] md:w-52 md:h-60 flex-shrink-0 rounded-3xl object-cover"
              />
            )}
          </div>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-col border border-[#22353E] rounded-lg overflow-hidden">
                    {/* Text Editor Toolbar */}
                    <div className="flex border-b border-[#22353E] overflow-x-auto">
                      <div className="flex items-center gap-1 sm:gap-2 px-1.5 sm:px-2 py-2 sm:py-3 border-r border-[#22353E] flex-shrink-0">
                        <button className="p-0.5 sm:p-1 text-[#697B7B] hover:text-[#F6F6F6] text-xs sm:text-sm">I</button>
                        <button className="p-0.5 sm:p-1 text-[#697B7B] hover:text-[#F6F6F6] text-xs sm:text-sm">B</button>
                        <button className="p-0.5 sm:p-1 text-[#697B7B] hover:text-[#F6F6F6] text-xs sm:text-sm">U</button>
                      </div>
                      <div className="flex items-center gap-1 sm:gap-2 px-1.5 sm:px-2 py-2 sm:py-3 border-r border-[#22353E] flex-shrink-0">
                        <button className="p-0.5 sm:p-1 text-[#697B7B] hover:text-[#F6F6F6] text-xs sm:text-sm">≡</button>
                        <button className="p-0.5 sm:p-1 text-[#697B7B] hover:text-[#F6F6F6] text-xs sm:text-sm">≡</button>
                        <button className="p-0.5 sm:p-1 text-[#697B7B] hover:text-[#F6F6F6] text-xs sm:text-sm">≡</button>
                      </div>
                      <div className="flex items-center gap-1 sm:gap-2 px-1.5 sm:px-2 py-2 sm:py-3 flex-shrink-0">
                        <button className="p-0.5 sm:p-1 text-[#697B7B] hover:text-[#F6F6F6] text-xs sm:text-sm">¶</button>
                        <button className="p-0.5 sm:p-1 text-[#697B7B] hover:text-[#F6F6F6] text-xs sm:text-sm">✎</button>
                        <button className="p-0.5 sm:p-1 text-[#697B7B] hover:text-[#F6F6F6] text-xs sm:text-sm">🖼</button>
                        <button className="p-0.5 sm:p-1 text-[#697B7B] hover:text-[#F6F6F6] text-xs sm:text-sm">📁</button>
                    ...
                    <textarea
                      ...
                      className="w-full h-28 sm:h-32 p-3 sm:p-4 bg-transparent text-[#F6F6F6] text-xs sm:text-sm md:text-base font-normal font-['Space Grotesk'] outline-none resize-none placeholder:text-[#697B7B]"
                    />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3 sm:gap-4">
                  <div className="flex justify-between items-center">
                    <span className="text-[#F6F6F6] text-sm sm:text-base font-normal font-['Space Grotesk']">Upload Image</span>
          ...
          {/* Action Buttons */}
          <div className="flex gap-2 sm:gap-3 md:gap-4 w-full mt-4 sm:mt-6">
            <button
              onClick={handleCancel}
              className="flex-1 h-10 sm:h-11 md:h-12 px-3 sm:px-4 md:px-5 border border-[#22353E] rounded-2xl text-[#697B7B] text-xs sm:text-sm font-bold font-['Space_Grotesk'] hover:bg-[#22353E] transition-colors whitespace-nowrap"
            >
              Cancel
            </button>
            <button
              onClick={handleSave}
              className="flex-1 h-10 sm:h-11 md:h-12 px-3 sm:px-4 md:px-5 bg-[#FE8A00] rounded-2xl text-[#151D26] text-xs sm:text-sm font-bold font-['Space_Grotesk'] hover:bg-[#FE8A00]/90 transition-colors whitespace-nowrap"
            >
              Save & Send Receipt
            </button>
          </div>
