...
import { ExBatchContent } from "@/components/ExBatchContent";
        ...
        <div className="px-3 sm:px-4 mt-6 space-y-4">
          ...
          {activeTab === "Info" ? (
            <>
              ...
              {/* Pagination */}
              <div className="pt-4">
                <XtagoPagination totalItems={85} currentPage={currentPage} totalPages={5} onPageChange={setCurrentPage} />
              </div>
            </>
          ) : (
            <>
              ...
              {/* Pagination for Ex-Batch */}
              <div className="pt-4">
                <XtagoPagination totalItems={24} currentPage={currentPage} totalPages={3} onPageChange={setCurrentPage} />
              </div>
            </>
          )}
        </div>
