    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex items-center w-full">
          ...
          <div className="flex w-[46px] p-4 flex-col justify-center items-center gap-2.5 flex-shrink-0 rounded-tl-3xl border-b border-[#22353E] bg-[#1C242E]">
            <FigmaCheckbox
          ...
          <div className="flex w-[273px] p-4 items-center gap-3 flex-shrink-0 border-b border-[#22353E] bg-[#1C242E]">
            <span className="text-[#C4C4C4] font-['Space_Grotesk'] text-sm font-normal">
          ...
          <div className="flex w-[77px] p-4 flex-col justify-center items-center gap-2.5 flex-shrink-0 rounded-tr-3xl border-b border-[#22353E] bg-[#1C242E]">
            <span className="text-[#C4C4C4] font-['Space_Grotesk'] text-sm font-normal">Quantity</span>
          </div>
        </div>
        ...
        {products.map((product, index) => {
          ...
          return (
            ...
            >
              {/* Checkbox Column */}
              <div className="flex w-[45px] h-[114px] p-4 justify-center items-center gap-2.5 border-r border-b border-l border-[#22353E]">
                <FigmaCheckbox
                  checked={isSelected}
              ...
              {/* Product Info Column */}
              <div className="flex w-[283px] h-[114px] p-3 items-center gap-[15px] border-b border-[#22353E]">
                {/* Product Image */}
                <img 
                  src={product.image} 
                  alt={product.name}
                  className="w-[60px] h-[66px] flex-shrink-0 rounded-lg object-cover"
                />
                
                {/* Product Details */}
                <div className="flex w-[207px] flex-col justify-center items-start gap-3 flex-shrink-0">
                  {/* Check if this is the special "Batch ID" format row */}
                  {product.name.includes('Batch id') ? (
                    <>
                      <div className="self-stretch text-[#F6F6F6] font-['Space_Grotesk'] text-base font-normal uppercase">
                        <span className="text-[#C4C4C4]">Batch id : </span>
                        <span className="text-[#F6F6F6]">{product.batchId}</span>
                      </div>
                      <div className="w-[208px] text-[#F6F6F6] font-['Space_Grotesk'] text-base font-medium">
                        {product.name.replace(/Batch id : \d+\s*/, '')}
                      </div>
                    </>
                  ) : (
                    <div className="w-[189px] text-[#F6F6F6] font-['Space_Grotesk'] text-base font-normal">
                      {product.name}
                    </div>
                  )}
                  
                  {/* Time Left Badge */}
                  <div className="flex w-[130px] h-5 px-3 py-1.5 justify-center items-center gap-2 rounded-2xl bg-[rgba(255,20,116,0.10)]">
                    <span className="text-[#FF1474] font-['Space_Grotesk'] text-xs font-normal">
                      {product.timeLeft}
                    </span>
                  </div>
                </div>
              ...
              {/* Quantity Column */}
              <div className="flex w-[69px] h-[114px] p-4 justify-center items-center gap-2.5 border-r border-b border-l border-[#22353E]">
