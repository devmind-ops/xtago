        ...
        <div ref={cardRef} className="inline-flex p-6 flex-col justify-center items-start gap-3 rounded-xl bg-[#1C242E] shadow-[0_0_88px_rgba(0,0,0,0.25)] w-[263px] max-w-[calc(100vw-16px)] max-h-[70vh]">
          ...
          <div className="flex w-[215px] p-5 flex-col items-center gap-[15px] rounded-xl bg-[#1C242E]">
            ...
            <div className="flex items-center gap-4 self-stretch">
              ...
              <button
                onClick={onClose}
                className="flex w-20 h-10 p-[18px_36px] justify-center items-center gap-2 rounded-2xl border border-[#22353E]"
              >
                <span className="text-[#697B7B] font-['Space_Grotesk'] text-base font-bold">
                  Cancel
                </span>
              </button>
              ...
              <button
                ...
                className="flex w-20 h-10 p-[18px_36px] justify-center items-center gap-2 rounded-2xl bg-[#FE8A00]"
              >
