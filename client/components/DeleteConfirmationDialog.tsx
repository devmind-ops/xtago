  ...
  return (
    <>
      ...
      <div className={`${inline ? 'fixed' : 'fixed'} z-50`} style={coords ?? { left: 16, top: 200 }}>
        <div ref={cardRef} className="relative inline-flex p-6 flex-col justify-center items-start gap-3 rounded-xl bg-[#1C242E] shadow-[0_0_88px_rgba(0,0,0,0.25)] w-[263px] h-[163px] max-w-[calc(100vw-32px)]">
          {/* Triangle pointer - positioned at top center */}
          ...
          <div className="flex w-[215px] p-5 flex-col items-center gap-[15px] rounded-xl bg-[#1C242E]">
            {/* Title */}
            <div className="self-stretch text-[#F6F6F6] text-center font-['Space_Grotesk'] text-base font-normal">
              Are You Sure?
            </div>
            ...
            <div className="flex items-center gap-4 self-stretch">
              ...
              <button
                onClick={onClose}
                className="flex w-20 h-10 px-[36px] py-[18px] justify-center items-center gap-2 rounded-2xl border border-[#22353E]"
              >
                <span className="text-[#697B7B] font-['Space_Grotesk'] text-base font-bold leading-normal">
                  Cancel
                </span>
              </button>
              ...
              <button
                ...
                className="flex w-20 h-10 px-[36px] py-[18px] justify-center items-center gap-2 rounded-2xl bg-[#FE8A00]"
              >
                <span className="text-[#151D26] font-['Space_Grotesk'] text-base font-bold leading-normal">
                  Delete
                </span>
              </button>
            </div>
